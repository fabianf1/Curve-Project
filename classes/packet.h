...
enum class Packet : int {ID,Sync,Name,StartGame,NewRound,Update,Points,GameEnd,RoundEnd,PowerupDelF,PowerupDelP,PowerupDelG,PowerupS,PowerupHit,PowerupEnd,Pause,Ready,DCon,Options,KeyL,KeyR,Lag,Countdown,Return_Setup,Request_Player,Remove_Player};
