...
void Main::eventHandler(){
    ...
    // Lost Focus Handler; Only pause if playing offline
    ...
    // Setup screen things
        ...
        // Key changer
        if( (game.keyChange[0] != -1) && (event.type == sf::Event::KeyPressed) ){
        ...
        // Name Changer
            ...
            // Only certain characters are accepted: Letters, certain special characters and numbers
